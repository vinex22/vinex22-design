 ...
 *   - Background / graphics 1:1 fidelity (Playwright embedded Chromium renders)
 *   - No HTML modifications required
 *   - Visual loss = 0 (the PDF is what the browser would print)
 *
 * Trade-offs:
 *   - PDF is not editable text (go back to HTML to change)
 *
