 ...
 * - Stage: whole animation container, provides time + control
 ...
 *   </Stage>
 *
 * Inside a Sprite child, use useSprite() to read the current segment's progress.
 */
...
(function() {
  ...
  const Easing = {
    ...
    // Fast start + slow brake, giving numerical elements physical weight
    expoOut: t => t === 1 ? 1 : 1 - Math.pow(2, -10 * t),
    // overshoot: bouncy toggle/button pop (cubic-bezier(0.34, 1.56, 0.64, 1))
    overshoot: t => {
